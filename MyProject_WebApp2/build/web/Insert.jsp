            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2 style="margin-bottom: 3%;float: left">Insert product</h2>
                    </div>
                </div>
            </div>
            <div class="row">
            <form class="col-lg-6" action="insert" method="POST">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input name="Unitprice" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                            <div class="mb-3">
                             <label for="exampleInputEmail1" class="form-label">SubCategory</label><br/>
                            <select name="subid">
                                <%for (SubCategory s : subs) {%>
                                       <option value="<%=s.getScid()%>"><%=s.getSubName() %></option>
                                <%}%>
                            </select>
                            </div><br/>
                            <br/><div class="mb-3">
                            ...
                            <%for (region r : regions) {%>
                                ...
                                value="<%=r.getRid() %>"/><%=r.getName() %><%=r.getRid() %>
                                 </div>
                            <%}%>
